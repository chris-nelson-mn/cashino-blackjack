...
# http://stackoverflow.com/a/28705325
RSpec::Matchers.define :have_attr_accessor_for do |field|
  ...
  description do
    "implement attr_accessor for #{field}"
  end
end

RSpec::Matchers.define :have_attr_reader_for do |field|
  match do |object_instance|
    object_instance.respond_to?(field)
  end
  ...
  description do
    "implement attr_reader for #{field}"
  end
end
